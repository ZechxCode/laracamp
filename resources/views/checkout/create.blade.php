                    ...
                    <div class="row">
                        <div class="col-lg-5 col-12">
                            <div class="item-bootcamp">
                                <img src="{{ url('images/item_bootcamp.png') }}" alt="" class="cover">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-12">
                                                ...
                                                <input name="expired" type="month"
                                                    class="form-control {{ $errors->has('expired') ? 'is-invalid' : '' }}"value="{{ old('expired') ?: '' }}"
                                                    required>
                                                @if ($errors->has('expired'))
                                                    <p class="text-danger">
                                                        {{ $errors->first('expired') }} </p>
                                                @endif
                                            </div>
                                            <div class="col-lg-6 col-12">
                                                <label class="form-label">CVC</label>
                                                <input name="cvc" type="number"
                                                    class="{{ $errors->has('cvc') ? 'is-invalid' : '' }}"
